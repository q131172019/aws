...
func GetHostList(inData string, excludeData string) ([]Hostdef, error) {
	...
	isAlive := []*string{aws.String("running"), aws.String("pending")}
	filterArray = append(filterArray, &ec2.Filter{Name: aws.String("instance-state-name"), Values: isAlive})
